...
namespace Kinspeed\Stores\Ui\Component\Listing\Column;
...
/**
 * @method StoreActions setName($name)
 */
class StoreActions extends Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'stores/stores/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'stores/stores/delete';
