...
class UrlRewrite extends Value
{
	...
	*/
    ...
    /**
     * @var \Kinspeed\Stores\Model\Stores\Url
     */
    protected $urlModel;
    ...
    public function afterSave()
    {
		...
		if($this->hasDataChanges()){ //different from default
			...
			$getCustomUrlRewrite = $this->_data["groups"]["store_content"]["fields"]["url"]["value"];
			...
			foreach ($this->_data as $key => $value) {
				...
				if($key == "field" && $value == "url"){
					...
					$filterData = [
		                UrlRewriteService::TARGET_PATH => "stores",
