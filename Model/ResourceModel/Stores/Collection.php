 ...
 */
namespace Kinspeed\Stores\Model\ResourceModel\Stores;
...
class Collection extends AbstractCollection
{
     ...
     * @var string
     */
    public $_idFieldName = 'store_id';
    /**
     * Event prefix
     *
     * @var string
     */
    public $_eventPrefix = 'kinspeed_stores_stores_collection';
     ...
     * @var string
     */
    public $_eventObject = 'store_collection';
    ...
    {
        $this->_init(Stores::class, StoreResourceModel::class);
    ...
    public function performAfterLoad($tableName, $linkField)
    {
        ...
        if (count($linkedIds)) {
            ...
            $select = $connection->select()->from(['kinspeed_stores_stores' => $this->getTable($tableName)])
                ->where('kinspeed_stores_stores.' . $linkField . ' IN (?)', $linkedIds);
