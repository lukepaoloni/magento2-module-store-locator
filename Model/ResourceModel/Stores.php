 ...
 */
namespace Kinspeed\Stores\Model\ResourceModel;
...
class Stores extends AbstractDb
{
    ...
    {
        $this->_init('kinspeed_stores_stores', 'store_id');
    }

    /**
     * Process store data before deleting
     *
    ...
    public function _beforeDelete(AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('kinspeed_stores_stores'), $condition);
     ...
     *
     * @param AbstractModel|\Kinspeed\Stores\Model\Stores $object
     * @return $this
     */
